...
const RequestCallFunnelV2 = () => {
  ...
  return (
    <>
      <SEO
        title="24/7 Emergency Operator | Answer In 60 Seconds Or Lose The Job"
        description="Every second counts. Answer emergency calls in 60 seconds or lose jobs to competitors. Get your 24/7 AI emergency booking assistant."
        url="/24-7-emergency-operator-v2"
      />
        ...
        <div className="flex-1 flex items-center justify-center px-3 sm:px-6 lg:px-8 py-8 sm:py-12">
          ...
          >
            <h1 className="text-3xl xs:text-4xl sm:text-5xl md:text-6xl font-bold text-white mb-3 xs:mb-4 sm:mb-5 leading-snug xs:leading-tight">
              If You Don't Answer In <span className="border-b-2 border-red-500">60 Seconds</span>, The Job Goes Elsewhere.
            </h1>
            <p className="text-lg xs:text-xl sm:text-2xl md:text-3xl lg:text-4xl font-semibold text-gray-300 mb-6 xs:mb-8 sm:mb-10 md:mb-12">
              Miss <span className="border-b-2 border-blue-500 text-white">2 calls</span> at <span className="border-b-2 border-blue-500 text-white">£250</span> each? <br className="hidden sm:block" />
              That's <span className="border-b-2 border-red-500 text-white">£26,000+</span> lost per year.
            </p>
            <motion.button
          ...
          >
            ...
            <div className="bg-gradient-to-r from-blue-900/30 to-slate-900/30 border border-blue-500/40 rounded-lg p-5 sm:p-6">
              <p className="text-sm sm:text-base text-red-400 mb-3">Every missed call is someone ready to book a job.</p>
            ...
            {/* Feature 2 */}
            <div className="bg-gradient-to-r from-blue-900/30 to-slate-900/30 border border-blue-500/40 rounded-lg p-5 sm:p-6">
              <p className="text-sm sm:text-base text-red-400 mb-3">Plumbers are under sinks, in lofts, driving, or on-site.</p>
            ...
            {/* Feature 3 */}
            <div className="bg-gradient-to-r from-blue-900/30 to-slate-900/30 border border-blue-500/40 rounded-lg p-5 sm:p-6">
              <p className="text-sm sm:text-base text-red-400 mb-3">If someone doesn't get a response quickly, they call the next business.</p>
            ...
            {/* Feature 4 */}
            <div className="bg-gradient-to-r from-blue-900/30 to-slate-900/30 border border-blue-500/40 rounded-lg p-5 sm:p-6">
              <p className="text-sm sm:text-base text-red-400 mb-3">Calls don't only happen during working hours.</p>
          ...
          <motion.div
            ...
            className="bg-gradient-to-r from-red-900/60 to-orange-900/60 border-2 border-red-500 rounded-lg p-4 sm:p-5 mb-8 sm:mb-12"
          >
            <p className="text-sm sm:text-base font-bold text-red-300 text-center">
              ⚠️ Only 3 spots remaining this month. Lock yours in now.
            </p>
          </motion.div>
...
export default RequestCallFunnelV2;
