...
const WifiOptimisation = () => {
  ...
  const testimonials = [
    { name: 'Lisa W.', initials: 'LW', role: 'Property Manager', result: 'Full signal across all rooms — no more weak spots', review: '"My broadband was fast but WiFi in the back rooms was useless. Cisconnects repositioned everything, added an access point, and now I have full signal everywhere. Simple fix, massive difference."' },
    ...
    { name: 'Sam L.', initials: 'SL', role: 'Home Office User', result: 'Getting 200Mbps on WiFi vs 18Mbps before', review: '"I was getting 18Mbps on WiFi when my broadband was 200Mbps. Turns out the router was in the wrong place. One session with Cisconnects and it\'s transformed."' },
          ...
          <div className="w-full max-w-2xl">
            ...
            >
              <div className="bg-gradient-to-r from-green-900/40 to-emerald-900/40 border-2 border-green-500/60 rounded-xl p-5 sm:p-7 mb-6 text-center">
                ...
                <h3 className="text-xl sm:text-2xl font-bold text-white mb-2">Our Guarantee</h3>
              ...
              <div className="grid grid-cols-2 gap-3">
                {[
                  { icon: '🛡', title: 'Fixed Price', desc: '£300 agreed upfront — no surprises' },
                  ...
                  { icon: '📋', title: 'Full Survey', desc: 'We map coverage before and after' },
