...
const ElectricianWebsiteServices = () => {
  ...
  const testimonials = [
    { name: 'Dave H.', initials: 'DH', role: 'Sole Trader Electrician', result: 'Phone ringing every day within 3 weeks', review: '"I was relying on word of mouth for years. Conxiea built me a website and within three weeks my phone was ringing every single day from Google."' },
    { name: 'Steve M.', initials: 'SM', role: 'Electrical Contractor', result: 'Booked out 6 weeks in advance', review: '"We went from chasing jobs to turning work away. The website pulls in leads on autopilot — I wish I\'d done this years ago."' },
    { name: 'Chris T.', initials: 'CT', role: 'Domestic Electrician', result: '12 new enquiries in the first month', review: '"Professional site, shows up on Google, and the leads it brings in are serious customers. Worth every penny."' },
    { name: 'Paul W.', initials: 'PW', role: 'Electrical Business Owner', result: 'Stopped paying for third-party lead sites', review: '"I was paying through the nose on lead sites and getting tyre-kickers. My own website brings in proper customers who are ready to book."' },
  ];
          ...
          <div className="w-full max-w-2xl">
            ...
            >
              <h1 className="text-2xl xs:text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-3 xs:mb-4 sm:mb-5 leading-tight">
                Your Competitors Are Getting Electrical Jobs Online.{' '}
              ...
              <p className="text-base xs:text-lg sm:text-xl md:text-2xl font-semibold text-gray-300 mb-5 xs:mb-7 sm:mb-10 md:mb-12">
                Over 1,000 people search for electricians in your area every week —{' '}
                <span className="border-b-2 border-blue-500 text-white">and they're booking whoever shows up.</span>
              </p>
              <motion.button
            ...
            >
              {[
                ...
                'Show Accreditations & Reviews to Win Trust Online',
            ...
            >
              <div className="bg-gradient-to-r from-blue-900/30 to-slate-900/30 border border-blue-500/40 rounded-lg p-5 sm:p-6">
                <p className="text-sm sm:text-base text-red-400 mb-3">Your competitors have websites — and they're taking jobs that should be yours.</p>
                <p className="text-sm sm:text-base text-white font-semibold mb-3">We build a professional website for electricians that ranks locally and turns searches into booked jobs.</p>
                <p className="text-xs sm:text-sm text-gray-300 mb-4">Scenario: A homeowner needs a consumer unit replacement. They Google "electrician near me." Your competitor shows up. You don't. We fix that.</p>
                <div className="flex justify-center">
                  <button onClick={() => document.getElementById('electrician-form').scrollIntoView({ behavior: 'smooth' })} className="bg-blue-600 hover:bg-blue-700 active:bg-blue-800 text-white text-sm font-semibold px-6 sm:px-8 py-3 rounded transition cursor-pointer min-h-[44px]">Get Found on Google</button>
                </div>
              </div>
              <div className="bg-gradient-to-r from-blue-900/30 to-slate-900/30 border border-blue-500/40 rounded-lg p-5 sm:p-6">
                <p className="text-sm sm:text-base text-red-400 mb-3">Relying on word of mouth has a ceiling — you can't scale it.</p>
                ...
                <p className="text-xs sm:text-sm text-gray-300 mb-4">Scenario: You finish a long day on site. Three new enquiries are waiting in your inbox. That's what a properly built electrician website does.</p>
                <div className="flex justify-center">
                  <button onClick={() => document.getElementById('electrician-form').scrollIntoView({ behavior: 'smooth' })} className="bg-blue-600 hover:bg-blue-700 active:bg-blue-800 text-white text-sm font-semibold px-6 sm:px-8 py-3 rounded transition cursor-pointer min-h-[44px]">Start Getting Enquiries</button>
                </div>
              </div>
              <div className="bg-gradient-to-r from-blue-900/30 to-slate-900/30 border border-blue-500/40 rounded-lg p-5 sm:p-6">
                <p className="text-sm sm:text-base text-red-400 mb-3">Without a professional website, customers can't verify who you are — and they'll choose someone they can.</p>
                <p className="text-sm sm:text-base text-white font-semibold mb-3">We showcase your NICEIC or NAPIT accreditation, reviews, and past work so customers trust you before they call.</p>
                <p className="text-xs sm:text-sm text-gray-300 mb-4">Scenario: Two electricians quoted the same job. One had a polished website with verified reviews. The customer chose them without hesitation.</p>
                <div className="flex justify-center">
                  <button onClick={() => document.getElementById('electrician-form').scrollIntoView({ behavior: 'smooth' })} className="bg-blue-600 hover:bg-blue-700 active:bg-blue-800 text-white text-sm font-semibold px-6 sm:px-8 py-3 rounded transition cursor-pointer min-h-[44px]">Build My Credibility</button>
                </div>
              </div>
              <div className="bg-gradient-to-r from-blue-900/30 to-slate-900/30 border border-blue-500/40 rounded-lg p-5 sm:p-6">
                <p className="text-sm sm:text-base text-red-400 mb-3">Lead platforms charge you for every enquiry — and most aren't worth it.</p>
                ...
                <p className="text-xs sm:text-sm text-gray-300 mb-4">Scenario: You're spending £200/month on Checkatrade leads. Your website replaces that — and the leads are better quality because they found you directly.</p>
                <div className="flex justify-center">
                  <button onClick={() => document.getElementById('electrician-form').scrollIntoView({ behavior: 'smooth' })} className="bg-blue-600 hover:bg-blue-700 active:bg-blue-800 text-white text-sm font-semibold px-6 sm:px-8 py-3 rounded transition cursor-pointer min-h-[44px]">Stop Paying Per Lead</button>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="grid grid-cols-2 gap-3 mb-6">
                {[
                  { number: '1,000+', label: 'Weekly Local Searches for Electricians' },
              ...
              <div className="flex items-center justify-center gap-3 mb-5 sm:mb-7">
                ...
                <h2 className="text-center text-lg sm:text-xl font-bold text-white whitespace-nowrap">What electricians say</h2>
                <div className="h-px flex-1 bg-slate-700" />
              </div>
            ...
            >
              ...
              >
                {isSubmitting ? (
                  ...
                  <><Send className="w-4 h-4 sm:w-5 sm:h-5" /><span>Get My Electrician Website</span></>
                )}
              </motion.button>
            </motion.form>
