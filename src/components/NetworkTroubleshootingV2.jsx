...
const NetworkTroubleshootingV2 = () => {
  ...
  return (
    <>
      <SEO
        title="Network Issues No One Can Fix? We Will | Conxiea"
          ...
          <div className="w-full max-w-2xl">
            ...
            >
              ...
              <p className="text-base xs:text-lg sm:text-xl md:text-2xl font-semibold text-gray-300 mb-5 xs:mb-7 sm:mb-10 md:mb-12">
                ...
                <span className="border-b-2 border-blue-500 text-white">when your internal team or IT support can't find the cause, we step in and solve it.</span>
              </p>
              <motion.button
            ...
            >
              <p className="text-sm sm:text-base text-gray-300 mb-3">Everything looks fine… until it isn't.</p>
              <p className="text-base sm:text-lg font-bold text-white leading-relaxed mb-3">
                The network drops.<br />
                Systems slow down.<br />
                Users complain.
              </p>
              <p className="text-sm sm:text-base text-gray-300">Your IT team checks everything — and still no clear answer.</p>
            </motion.div>
            ...
            >
              <p className="text-sm sm:text-base text-gray-300 leading-relaxed">
                Most IT support teams fix obvious issues.<br />
                <span className="text-white font-semibold">We specialise in the ones that don't have obvious answers.</span>
              </p>
            </motion.div>
            ...
            >
              <p className="text-sm sm:text-base text-gray-300 mb-4">
                We go deeper — analysing traffic, configurations, and real-world behaviour to find the root cause.
              </p>
            ...
            >
              <p className="text-base sm:text-lg font-bold text-white">If it was easy to fix, it would already be fixed.</p>
            </motion.div>
            ...
            >
              <p className="text-xl sm:text-2xl font-bold text-white mb-1">24–48 hours</p>
              <p className="text-sm sm:text-base text-gray-300">Most issues diagnosed within 24–48 hours</p>
            </motion.div>
            ...
            >
              <p className="text-base sm:text-lg font-bold text-white leading-relaxed mb-2">
                Your network works… most of the time.<br />
                But randomly, things fail — and no one knows why.
              </p>
            ...
            >
              <div className="grid grid-cols-2 gap-3 mb-6">
                {[
                  ...
                  { number: '24–48hrs', label: 'Average Diagnosis Time' },
            ...
            >
              ...
              >
                {isSubmitting ? (
                  ...
                  <><Send className="w-4 h-4 sm:w-5 sm:h-5" /><span>Fix My Network Issue</span></>
                )}
              </motion.button>
            </motion.form>
...
export default NetworkTroubleshootingV2;
