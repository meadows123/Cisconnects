...
const CafeWifi = () => {
  ...
  const testimonials = [
    { name: 'Sarah T.', initials: 'ST', role: 'Café Owner', result: 'Zero card machine failures since install', review: '"Our card machines used to drop at least once a day. Since Cisconnects sorted our network we haven\'t had a single issue. Absolute lifesavers."' },
    ...
    { name: 'James R.', initials: 'JR', role: 'Bistro Owner', result: 'WiFi ready for opening day — completely stress-free', review: '"We opened a new café and the WiFi on opening day was a disaster. Cisconnects came the next day and transformed the whole setup. Absolute lifesavers."' },
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-3">
                {[
                  ...
                  { icon: '📋', title: 'Full Survey', desc: 'We assess the whole space properly' },
