...
const TradesWebsiteServices = () => {
  ...
  const testimonials = [
    { name: 'Ryan T.', initials: 'RT', role: 'Plumber', result: 'Fully booked within 4 weeks of going live', review: '"I had no website, just word of mouth. Conxiea built me a site and within a month I was turning jobs away. My phone hasn\'t stopped."' },
    { name: 'Mark D.', initials: 'MD', role: 'Emergency Locksmith', result: '3x more call-outs from Google in the first month', review: '"Emergency call-outs are all about being first on Google. Conxiea got me there fast. My competitors had been there for years — I overtook them in weeks."' },
    { name: 'Craig B.', initials: 'CB', role: 'Roofer', result: 'Stopped relying on word of mouth overnight', review: '"Roofing is competitive. I needed to be found online. Conxiea built a site that actually shows up on Google and the quality of enquiries is far better than lead sites."' },
    { name: 'Andy S.', initials: 'AS', role: 'Emergency Repair Specialist', result: '£200/mo saved — ditched Checkatrade', review: '"I was paying Checkatrade and getting tyre-kickers. My own website brings in customers who are ready to book. I wish I\'d done this two years ago."' },
  ];
  ...
  return (
    <>
      <SEO
        title="Websites for Tradespeople That Bring You More Work | Conxiea"
        description="Need a website for your trade business? Conxiea builds professional websites for plumbers, locksmiths, roofers, and emergency repair services that rank on Google and turn local searches into booked jobs."
        keywords="website for tradespeople, plumber website, locksmith website, roofer website, trades website UK, website for local tradespeople"
        url="/website-for-trades"
        structuredData={{
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Website for Tradespeople",
          "description": "Professional website design and SEO for plumbers, locksmiths, roofers, and emergency repair services. Get found on Google and turn local searches into booked jobs.",
          "provider": {
            "@type": "Organization",
            "name": "Conxiea",
          ...
          "serviceType": "Website Design & SEO for Tradespeople"
        }}
      />
      <div className="min-h-screen bg-[#0f0f3d] flex flex-col relative">
        ...
        <main className="flex-1 flex items-center justify-center px-3 sm:px-6 lg:px-8 py-8 sm:py-12">
          <div className="w-full max-w-2xl">
            ...
            >
              <p className="text-xs sm:text-sm font-semibold text-blue-400 uppercase tracking-wide mb-3">For Plumbers · Locksmiths · Roofers · Emergency Repair</p>
              <h1 className="text-3xl xs:text-4xl sm:text-5xl md:text-6xl font-bold text-white mb-3 xs:mb-4 sm:mb-5 leading-tight">
                Your Competitors Are Getting Trade Jobs Online.{' '}
                <span className="border-b-2 border-blue-500">You're Not.</span>
              </h1>
              <p className="text-base xs:text-lg sm:text-xl md:text-2xl font-semibold text-gray-300 mb-5 xs:mb-7 sm:mb-10 md:mb-12">
                Hundreds of people search for your trade in your area every week —{' '}
                <span className="border-b-2 border-blue-500 text-white">and they're booking whoever shows up first.</span>
              </p>
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                onClick={() => document.getElementById('trades-form').scrollIntoView({ behavior: 'smooth' })}
            ...
            >
              {[
                'Stop Being Invisible on Local Google Searches',
                'New Enquiries Coming In — Not Just Word of Mouth',
                'Build Trust With Reviews & Past Work Online',
                'Stop Paying for Low-Quality Leads That Waste Your Time',
              ].map((benefit, i) => (
            ...
            >
              <div className="bg-gradient-to-r from-blue-900/30 to-slate-900/30 border border-blue-500/40 rounded-lg p-5 sm:p-6">
                <p className="text-sm sm:text-base text-red-400 mb-3">Every day you don't show up on Google, a competitor with a website is taking jobs that should be yours.</p>
                <p className="text-sm sm:text-base text-white font-semibold mb-3">We build a professional website for your trade that ranks locally and turns searches into booked jobs.</p>
                <p className="text-xs sm:text-sm text-gray-300 mb-4">Scenario: A homeowner searches "plumber near me" at 8pm with a burst pipe. Your competitor's site comes up first. Yours doesn't exist. We fix that.</p>
                <div className="flex justify-center">
                  <button onClick={() => document.getElementById('trades-form').scrollIntoView({ behavior: 'smooth' })} className="bg-blue-600 hover:bg-blue-700 active:bg-blue-800 text-white text-sm font-semibold px-6 sm:px-8 py-3 rounded transition cursor-pointer min-h-[44px]">Get Found on Google</button>
                </div>
              </div>
              <div className="bg-gradient-to-r from-blue-900/30 to-slate-900/30 border border-blue-500/40 rounded-lg p-5 sm:p-6">
                <p className="text-sm sm:text-base text-red-400 mb-3">Word of mouth has a ceiling — you can't grow beyond the people you already know.</p>
                <p className="text-sm sm:text-base text-white font-semibold mb-3">Your website works 24/7, capturing enquiries while you're on a job, in the van, or at home.</p>
                <p className="text-xs sm:text-sm text-gray-300 mb-4">Scenario: A locksmith finishes a call-out at midnight. Two new enquiries from Google are already waiting. That's what a properly built trades website does.</p>
                <div className="flex justify-center">
                  <button onClick={() => document.getElementById('trades-form').scrollIntoView({ behavior: 'smooth' })} className="bg-blue-600 hover:bg-blue-700 active:bg-blue-800 text-white text-sm font-semibold px-6 sm:px-8 py-3 rounded transition cursor-pointer min-h-[44px]">Start Getting Enquiries</button>
                </div>
              </div>
              <div className="bg-gradient-to-r from-blue-900/30 to-slate-900/30 border border-blue-500/40 rounded-lg p-5 sm:p-6">
                <p className="text-sm sm:text-base text-red-400 mb-3">Without a website, customers can't verify who you are — so they'll choose someone they can check out.</p>
                <p className="text-sm sm:text-base text-white font-semibold mb-3">We showcase your qualifications, reviews, and past work so customers trust you before they even pick up the phone.</p>
                <p className="text-xs sm:text-sm text-gray-300 mb-4">Scenario: Two roofers quote the same job. One has a website with photos and reviews. The other doesn't. The customer picks up the phone to the one with the website every time.</p>
                <div className="flex justify-center">
                  <button onClick={() => document.getElementById('trades-form').scrollIntoView({ behavior: 'smooth' })} className="bg-blue-600 hover:bg-blue-700 active:bg-blue-800 text-white text-sm font-semibold px-6 sm:px-8 py-3 rounded transition cursor-pointer min-h-[44px]">Build My Credibility</button>
                </div>
              </div>
              <div className="bg-gradient-to-r from-blue-900/30 to-slate-900/30 border border-blue-500/40 rounded-lg p-5 sm:p-6">
                <p className="text-sm sm:text-base text-red-400 mb-3">Lead platforms charge you for every enquiry — and most of those leads go cold or don't convert.</p>
                <p className="text-sm sm:text-base text-white font-semibold mb-3">Your own website generates enquiries for free, month after month, with no per-lead fees.</p>
                <p className="text-xs sm:text-sm text-gray-300 mb-4">Scenario: You're spending £200/month on Checkatrade or MyBuilder and chasing poor-quality leads. Your own website replaces that — and the customers who find you directly are ready to book.</p>
                <div className="flex justify-center">
                  <button onClick={() => document.getElementById('trades-form').scrollIntoView({ behavior: 'smooth' })} className="bg-blue-600 hover:bg-blue-700 active:bg-blue-800 text-white text-sm font-semibold px-6 sm:px-8 py-3 rounded transition cursor-pointer min-h-[44px]">Stop Paying Per Lead</button>
                </div>
              </div>
            </motion.div>
            ...
            {submitStatus === 'success' && (
              <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="mb-6 sm:mb-8 p-4 sm:p-6 bg-green-500/10 border border-green-500/50 rounded-lg flex items-start gap-3 sm:gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm sm:text-base text-green-300">We'll be in touch within 24 hours.</p>
                </div>
              </motion.div>
            )}
            {submitStatus === 'error' && (
              <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="mb-6 sm:mb-8 p-4 sm:p-6 bg-red-500/10 border border-red-500/50 rounded-lg flex items-start gap-3 sm:gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm sm:text-base text-red-300">Please try again or email <a href="mailto:admin@conxiea.com" className="underline">admin@conxiea.com</a></p>
                </div>
              </motion.div>
            )}
            ...
            >
              <div className="grid grid-cols-2 gap-3 mb-6">
                {[
                  { number: '500+', label: 'Weekly Local Searches for Your Trade' },
                  { number: '4.9★', label: 'Google Rating' },
                  { number: '97%', label: 'Of Clicks Go to Page 1 Results' },
              ...
              <div className="flex items-center justify-center gap-3 mb-5 sm:mb-7">
                ...
                <h2 className="text-center text-lg sm:text-xl font-bold text-white whitespace-nowrap">What tradespeople say</h2>
                <div className="h-px flex-1 bg-slate-700" />
              </div>
            ...
            >
              <div className="bg-gradient-to-r from-green-900/40 to-emerald-900/40 border-2 border-green-500/60 rounded-xl p-5 sm:p-7 text-center">
                ...
                <p className="text-base sm:text-lg text-green-300 font-semibold mb-3">"If you're not happy with your website before it goes live, you don't pay."</p>
                <p className="text-sm text-gray-400">We build it, you approve it. No approval, no charge — simple as that.</p>
              </div>
            </motion.div>
            ...
            >
              ...
              >
                {isSubmitting ? (
                  ...
                  <><Send className="w-4 h-4 sm:w-5 sm:h-5" /><span>Get My Trades Website</span></>
                )}
              </motion.button>
            </motion.form>
            ...
            >
              <div className="bg-gradient-to-r from-yellow-500/10 to-orange-500/10 border-2 border-yellow-400/60 rounded-xl p-5 sm:p-7">
                ...
                <div className="border-t border-yellow-400/20 pt-4 space-y-2 mb-4">
                  <p className="text-sm sm:text-base text-white"><span className="text-green-400 font-bold mr-2">✓</span><span className="font-semibold">Custom Trades Website</span></p>
                  ...
                  <p className="text-sm sm:text-base text-white"><span className="text-green-400 font-bold mr-2">✓</span><span className="font-semibold">Reviews, Services Pages & Contact Form</span></p>
                </div>
                <button
                  onClick={() => document.getElementById('trades-form').scrollIntoView({ behavior: 'smooth' })}
...
export default TradesWebsiteServices;
